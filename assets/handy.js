...
var VariantHelper = function () {
  ...
  createClass(VariantHelper, [{
    ...
    value: function isDefault() {
      if ((this.product.variants[0].title === 'Default Title' && this.product.variants[0].option1 === 'Default Title') || (this.product.variants[0].title === 'Default' && this.product.variants[0].option1 === 'Default')) {
        return true;
      }
